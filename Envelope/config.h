...
#define MIN_PHASE_DURATION_MICROS 1
#define MAX_PHASE_DURATION_MICROS (5 * MILLION)
const uint32_t ATTACK_MAX_DURATION_MICROS = MAX_PHASE_DURATION_MICROS;
const uint32_t ATTACK_MIN_DURATION_MICROS = MIN_PHASE_DURATION_MICROS;
const uint32_t DECAY_MAX_DURATION_MICROS = MAX_PHASE_DURATION_MICROS;
const uint32_t DECAY_MIN_DURATION_MICROS = MIN_PHASE_DURATION_MICROS;
//sustain time only used in TRAP mode
const uint32_t SUSTAIN_MAX_DURATION_MICROS = MAX_PHASE_DURATION_MICROS;
const uint32_t SUSTAIN_MIN_DURATION_MICROS = MIN_PHASE_DURATION_MICROS;
const uint32_t RELEASE_MAX_DURATION_MICROS = MAX_PHASE_DURATION_MICROS;
const uint32_t RELEASE_MIN_DURATION_MICROS = MIN_PHASE_DURATION_MICROS;
const uint32_t DELAY_MAX_DURATION_MICROS = MAX_PHASE_DURATION_MICROS;
const uint32_t DELAY_MIN_DURATION_MICROS = MIN_PHASE_DURATION_MICROS;
