...
Note how the output jacks J5-J8 partially hang off the board. See the note in the BoM.
...
Interactive BOM: [front](https://quinnfreedman.github.io/fm-artifacts/Envelope/envelope_pcb_front_interactive_bom.html), [back](https://quinnfreedman.github.io/fm-artifacts/Envelope/envelope_pcb_back_interactive_bom.html)
...
|    | Front | R9-R12         | Resistor         | 2kΩ                                     | [Tayda](https://www.taydaelectronics.com/resistors/1-4w-metal-film-resistors/test-group-2.html) | Should be 1/5 the value of the potentiometers. So if you are using 50kΩ pots, use 10kΩ resistors here instead. |
|    | Back  | R13-R20        | Resistor         | 100kΩ                                   |         | |
|    | Back  | R21-R24        | Resistor         | 10kΩ                                    | [Tayda](https://www.taydaelectronics.com/10-x-resistor-10k-ohm-1-4w-1-metal-film-pkg-of-10.html) | Determines LED brightness. Any value between 220Ω-10kΩ might be appropriate depending on which LEDs you have and how bright you want them. Lower resistance values mean more current and brighter LEDs. |
|    | Front | R25, R26       | Resistor         | 1kΩ                                      | [Tayda](https://www.taydaelectronics.com/10-x-resistor-1k-ohm-1-4w-1-metal-film-pkg-of-10.html) | Determines output impedance |
...
|    | Front | J1-J8          | 3.5mm Jack       | THONKICONN (a.k.a PJ398SM or PJ301M-12) | [Tayda](https://www.taydaelectronics.com/pj-3001f-3-5-mm-mono-phone-jack.html), [Thonk](https://www.thonk.co.uk/shop/thonkiconn/) | The bottom row of jacks (J5-J8) hangs one leg off the board. This is in order to keep the cost down, since boards <10cm tall can be printed for a cheaper flat rate. There is a pad labelled GND at the bottom of the module. Use a couple spare resistor legs or bit of wire to connect it to all 4 hanging legs. If you don't ground them, everything should still work fine, but it's good practice to do it for the best signal integrity. |
|    | Front | D1-D4          | LED              | 3mm                                     | [Tayda](https://www.taydaelectronics.com/leds/round-leds/3mm-leds.html) | My design uses 4 colors (amber, blue, red, green) to match the 4 knob colors, but obviously use whatever colors you want. Different colors might have slightly different brightnesses so you could tune R20-R24 to make them uniform. |
...
|    | Back  | J13            | IDC connector    | 2x8                                     | [Tayda](https://www.taydaelectronics.com/16-pin-box-header-connector-2-54mm.html) | Eurorack power header. Can use two rows of male pin headers or a shrouded connector (recommended). |
