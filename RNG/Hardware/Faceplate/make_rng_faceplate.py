...
module = Module(10, 10, title="RNG", filename="rng_faceplate.svg")
...
module.add(Potentiometer(-inches(.6), inches(1), label="Chaos"))
module.add(Potentiometer(inches(.4), inches(1), label="Time"))
module.add(Potentiometer(-inches(.6), inches(2), label="Spread"))
module.add(Potentiometer(inches(.4), inches(2), label="Bias"))
